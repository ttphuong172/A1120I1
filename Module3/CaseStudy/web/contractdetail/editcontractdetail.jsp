...
<div class="container-fluid">
    ...
    <div id="main" class="row">
        ...
        <div class="bodyarea col-sm-10">
            <h3>Chỉnh sửa dịch vụ cộng thêm</h3>
            <form action="/contractdetail?action=edit" method="post" class="form-group">
                <table class="table">
                    <tr>
                        <td><label for="">Mã HDCT</label></td>
                        <td><input type="text" name="detailcontractid" value="${detailContract.detailContractId}" readonly="readonly"></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="quantity" value="${detailContract.quantity}"></td>
                    </tr>

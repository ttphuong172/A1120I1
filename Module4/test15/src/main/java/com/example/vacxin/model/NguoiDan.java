...
@Entity
//@Table(uniqueConstraints=@UniqueConstraint(columnNames={"soCMND"}))
...
//    @NotBlank(message = "Vui lòng nhập nghề nghiệp")
    private String ngheNghiep;

    public NguoiDan() {
    }

    public NguoiDan(int idNguoiDan, String ten, LocalDate ngaySinh, Integer soNha, Duong duong, String soCMND, String soBHYT, String soDienThoai, String ngheNghiep) {
    ...
    public void validate(Object target, Errors errors) {
        ...
        if (nguoiDan.soNha== null) {
            errors.rejectValue("soNha", null, "Vui lòng nhập số nhà");
        }
...
//        }
        ...
        if (nguoiDan.ngaySinh != null) {
            if (ChronoUnit.YEARS.between(nguoiDan.ngaySinh, LocalDate.now()) <4) {
                errors.rejectValue("ngaySinh", null, "Chưa đủ tuổi để tiêm vacxin");
            }
        }
    }
}

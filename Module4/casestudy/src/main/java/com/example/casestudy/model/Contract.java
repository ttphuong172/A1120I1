...
public class Contract implements Validator {
    ...
    public Contract(int contractId, LocalDate contractStartDate, LocalDate contractEndDate, double contractDeposit, double contractTotalMoney, List<ContractDetail> contractDetailList, Employee employee, Customer customer, Service service) {

...
function displayCustommer() {
    ...
    for (i = 0; i < arrNameCustomers2.length; i++) {
        ...
        myString += '<td> <button onclick="editCustommer('+i+')">Edit</button> </td>' + ' <td> <button onclick="deleteCustommer(' + i + ')"> Delete</button> </td>' + '</tr>'
    }
    myString += '</table>'
...
function editCustommer(index){
    ...
    document.getElementById('name').value=arrNameCustomers2[index][0]
    document.getElementById('cmnd').value=arrNameCustomers2[index][1]
    document.getElementById('email').value=arrNameCustomers2[index][2]
    document.getElementById('address').value=arrNameCustomers2[index][3]
}
...
function checkCMND() {
    ...
    if (isNaN(inputcmnd)) {
        ...
        return false
    } else if (inputcmnd.trim().length !== 9) {
        document.getElementById('errorcmnd').innerHTML = 'Số CMND phải 9 số'
        return false
    } else {
